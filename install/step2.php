        ...
        <div class="landing-box">
            ...
            <div class="panel-body">
                ...
                if (version_compare(PHP_VERSION, '5.4.0') >= 0) {
                    $text .= '<h5>To Run the '.$app_name.' script, you need at least PHP version 5.4.0</h5><h5>Your PHP Version is : '.PHP_VERSION.' <span class="label label-table label-success">PASSED</span></h5>';
                    $passed .= '1';

                } else {
                    $text .= '<h5 class="m-b-0">To Run '.$app_name.' You need at least PHP version 5.5.0</h5><h5>Your PHP Version is : '.PHP_VERSION.' <span class="label label-table label-danger">PASSED</span></h5>';
                    $passed .= '0';
